 ...
 */
public class MaintainProductCatalog extends JInternalFrame implements
		ParentWindow, IComboObserver {
	...
	// table config
	private final String[] DEFAULT_COLUMN_HEADERS = { NAME, PRICE, MFG_DATE,
			QUANTITIES };
	...
	public void defineComboPanel() {
		...
		comboAction
				.putValue(CustomerConstants.COMBO, this.getClass().getName());
	...
	public void defineLowerPanel() {
		...
		backToMainButton.addActionListener(control
				.getBackToMainFromProdsListener(this));

		// create lower panel
		JButton[] buttons = { addButton, editButton, deleteButton,
				searchButton, backToMainButton };
	...
	/*
	 * class ComboBoxListener implements ActionListener { public void
	 * actionPerformed(ActionEvent evt) { catalogGroup =
	 * (String)catalogTypeCombo.getSelectedItem(); updateModel(); updateTable();
	 * } }
	 */
	...
	public JComboBox getcatalogTypeCombo() {
		return catalogTypeCombo;
	}
	...
	public void updateCombocatalog(List<String[]> items) {
		...
		while (iterator.hasNext()) {
			...
			catalogTypeCombo.addItem(catalog);
