...
/**
 * Class Description: This screen presents the list of all E-Bazaar catalogs. As
 * of creation date, there were just two catalogs in the default data: Books and
 * Clothes. Clicking the Browse button when one of the catalogs has been
 * selected invokes an instance of ProductListWindow, displaying the available
 * items for the selected catalog. Students: See the readdata method for where
 * data is put into the table.
 */
