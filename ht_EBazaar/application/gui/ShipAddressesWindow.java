...
/**
 * Class Description: This class displays a list of all the customer's addresses
 * on record (on initial creation, just one address is displayed, from fake data
 * in DefaultData). This class is invoked by ShippingBillingWindow as a means to
 * fill in the shipping address on its screen.
 */
public class ShipAddressesWindow extends JInternalFrame implements ParentWindow {
	...
	private void initializeWindow() {
		...
		setSize(GuiUtil.SCREEN_WIDTH, Math.round(GuiUtil.SCREEN_HEIGHT));
	...
	public void defineLowerPanel() {
		...
		selectButton
				.addActionListener(control.getSelectAddressesListener(this));
