...
public interface IProductSubsystem {
	...
	/**
	 * gets a list of products from the database, based on category type; if
	 * list is already in memory then
	 * 
	...
	public void runQuantityRules(Quantity quantity) throws RuleException,
			EBazaarException;
