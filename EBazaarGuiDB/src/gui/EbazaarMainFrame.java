...
public class EbazaarMainFrame extends javax.swing.JFrame {
	...
	private void insertLogo() {
		// homayoon @Oct.29
		String imagePath = GuiControl.CURR_DIR + "/src/images/logo.jpg";
		if (homayoon.OSValidator.isWindows())
			imagePath = GuiControl.CURR_DIR + "\\src\\images\\logo.jpg";
		// nooyamoh
		
		ImageIcon image = new ImageIcon(imagePath);//GuiControl.SPLASH_IMAGE);
		//System.out.println(GuiControl.SPLASH_IMAGE);
